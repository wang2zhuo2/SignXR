...
namespace Leap.Unity.Examples {
  ...
  public class SimpleFacingCameraCallbacks : MonoBehaviour {
        ...
        public Camera assignedCamera; // new added line
    ...
    private void initialize() {
      ...
      _isFacingCamera = !GetIsFacingCamera(toFaceCamera, assignedCamera);
      _initialized = true;
    }
    ...
    void Update() {
      ...
      if (GetIsFacingCamera(toFaceCamera, assignedCamera, _isFacingCamera ? 0.77F : 0.82F) != _isFacingCamera) {
